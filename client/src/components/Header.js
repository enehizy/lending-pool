...
export default function Header(){
   const[show,setShow]=useState(false)
    return(
        ...
        <button className="flex align-items-center border border-gray-500 md:p-2 rounded-full" onClick={()=>{
          setShow(!show)
        }}>
    ...
    >
      <g>
       ...
       {/* <Identicon address="0x47B2812CC92981998C61E4CD63e4Fd5A7C32e585"/> */}
        ...
        {/* <div className="flex bg-gray-100 p-2 rounded-full font-bold ">
          0x47B28...C32e585<Identicon address="0x47B2812CC92981998C61E4CD63e4Fd5A7C32e585"/> 
          </div> */}
